package
{
    ...
    public class PlayaHaterProgressiveFlashVars extends Sprite
    {
        private var _textArea:TextArea;
        private var _playa:PlayaHater;
        private var _media:Array=["http://media.newtriks.com/flvs/lif.flv"];

        public function PlayaHaterProgressiveFlashVars()
        {
        ...
        protected function buildUI():void
        {
            ...
            if(flashVarParams['media']!=undefined&&
                    flashVarParams['media']!='')
            {
                videoLogHandler("FlashVars: ".concat(flashVarParams['media']));
                _media=[flashVarParams['media']];
            }
        ...
        protected function get flashVarParams():Object
        {
